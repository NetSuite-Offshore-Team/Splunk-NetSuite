 ...
 */
/*
* Script modified for CPQ ENHC0051477, to comment the code that retrieves SFDC Unit Cost and SFDC Total Amount on un-check Override Unit Cost and Total Amount, 
* so that the Unit Cost and Amount fields do not override the user entered values
* @ AUTHOR : Unitha Rangam
* @Release Date 3rd April 2015
* @Release Number RLSE0050326
* @Project Number ENHC0051477 
* @version 1.3
 */
						...
						for(var a = 1; a <= linecount; a++){
							...
							for(var b = a; b <= lineitemcount; b++){
								...
								if((linenum == lineno) && (Qitem == SOitem)) {
									...
									//Removed code lines for CPQ ENHC0051477 , to not update Total Amount and Unit Cost on uncheck Override amount and Unit cost
