...
*/
/*
* Script changes on After submit to calculate and set Tax in NS on create/update. ENHC0051967 - Make the script parameter for tax codes editable.
		...
		if(eventtype == 'create' || eventtype == 'edit') {
			...
			for(i=1;i<count+1;i++) {
				...
				if (ItemId != '-3' && isparamtaxcode == 1) {
					...
					var sfdcunitCost = r.getLineItemValue('item','custcol_spk_sfdc_unit_cost',i);
					if(sfdcunitCost) {
